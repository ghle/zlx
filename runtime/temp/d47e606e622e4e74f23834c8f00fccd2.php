<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\phpStudy\WWW\zlx\public/../application/admin\view\zlxcpgl\edit.html";i:1534946238;s:71:"D:\phpStudy\WWW\zlx\public/../application/admin\view\template\base.html";i:1488957233;s:82:"D:\phpStudy\WWW\zlx\public/../application/admin\view\template\javascript_vars.html";i:1488957233;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" id="upload" placeholder="请点击后面的上传按钮" datatype="*" nullmsg="请填写图片url" style="width: 70%"   name="zlxslt" value="<?php echo isset($vo['zlxslt']) ? $vo['zlxslt'] :  ''; ?>" >
